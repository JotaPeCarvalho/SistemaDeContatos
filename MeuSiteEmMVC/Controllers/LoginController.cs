        ...
        public IActionResult Entrar(LoginModel loginModel)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    TempData["MensagemErro"] = $"Usuário e/ou senha estão inválido(s). Por favor, tente novamente.";
                }
                return View("Index");
            } 
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (usuario != null)
                    {
                       ...
                       bool emailEnviado = _email.Enviar(usuario.Email, "Sistema de Contatos - Nova Senha", mensagem);
                        ...
                        {
                           TempData["MensagemErro"] = $"Não conseguimos enviar ao e-mail, por favor, tente novamente";
                        }
